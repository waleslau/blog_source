...
mkdir kafka
tar -zxvf kafka_2.13-3.2.0.tgz -C kafka --strip-component=1
# 创建用来运行kafka的系统用户
...
二选一，无特别要求就选 [Kafka Without ZooKeeper](#21-kafka-without-zookeeper)
